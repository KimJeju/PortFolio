...
document.getElementById('spring').addEventListener('click', filterSelection.bind(null, 'spring'));
document.getElementById('unity').addEventListener('click', filterSelection.bind(null, 'unity'));
document.getElementById('db').addEventListener('click', filterSelection.bind(null, 'db'));
document.getElementById('ohters').addEventListener('click', filterSelection.bind(null, 'ohters'));
